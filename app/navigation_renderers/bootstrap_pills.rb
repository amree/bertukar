...
class BootstrapPills < SimpleNavigation::Renderer::Base
  def render(item_container)
    ...
    if skip_if_empty? && item_container.empty?
      ...
      content_tag(:ul, list_content, { id: item_container.dom_id, class: "#{item_container.dom_class} nav nav-pills pull-right" })
    end
  end
end
