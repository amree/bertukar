...
# Bertukar::Application.config.secret_token = 'f9bc917c85c7e6e36c1358c7d86dddc600072ea879d720249fe391d7841e626fc6dc51212bbc6ec7d103eda1c0540a9eaa616c91a1ece0360f1d06e46852be15'
...
if ENV["SECRET_TOKEN"].blank?
  if Rails.env.production?
    ...
    ENV["SECRET_TOKEN"] = Bertukar::Application.config.secret_token = SecureRandom.hex(30)
  else
...
Bertukar::Application.config.secret_token = ENV["SECRET_TOKEN"]
